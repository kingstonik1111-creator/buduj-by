...
# ─────────────────────────────────────────────────────────────
CITIES = {
    "minsk":   {"name": "Минск",   "loc": "в Минске",   "gen": "Минска"},
    # вторая волна — раскомментировать после первых замеров
    # "brest":   {"name": "Брест",   "loc": "в Бресте",   "gen": "Бреста"},
    # "grodno":  {"name": "Гродно",  "loc": "в Гродно",   "gen": "Гродно"},
    # "vitebsk": {"name": "Витебск", "loc": "в Витебске", "gen": "Витебска"},
    # "gomel":   {"name": "Гомель",  "loc": "в Гомеле",   "gen": "Гомеля"},
    # "mogilev": {"name": "Могилёв", "loc": "в Могилёве", "gen": "Могилёва"},
}
